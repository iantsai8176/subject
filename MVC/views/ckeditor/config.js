...
CKEDITOR.editorConfig = function( config ) {
	...
	config.filebrowserBrowseUrl = 'ckfinder/ckfinder.html';
	 config.filebrowserImageBrowseUrl = '/Project/MVC/views/ckfinder/ckfinder.html?Type=Images';
	 config.filebrowserFlashBrowseUrl = '/Project/MVC/views/ckfinder/ckfinder.html?Type=Flash';
